<h1>655 - Print Binary Tree</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/print-binary-tree/">print-binary-tree</a></h2><p>Given the <code>root</code> of a binary tree, construct a <strong>0-indexed</strong> <code>m x n</code> string matrix <code>res</code> that represents a <strong>formatted layout</strong> of the tree. The formatted layout matrix should be constructed using the following rules:</p>
