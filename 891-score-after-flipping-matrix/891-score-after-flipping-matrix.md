<h1>891 - Score After Flipping Matrix</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/score-after-flipping-matrix/">score-after-flipping-matrix</a></h2><p>You are given an <code>m x n</code> binary matrix <code>grid</code>.</p>
