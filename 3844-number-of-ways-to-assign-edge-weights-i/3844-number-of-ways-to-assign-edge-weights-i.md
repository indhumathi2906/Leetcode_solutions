<h1>3844 - Number of Ways to Assign Edge Weights I</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/number-of-ways-to-assign-edge-weights-i/">number-of-ways-to-assign-edge-weights-i</a></h2><p>There is an undirected tree with <code>n</code> nodes labeled from 1 to <code>n</code>, rooted at node 1. The tree is represented by a 2D integer array <code>edges</code> of length <code>n - 1</code>, where <code>edges[i] = [u<sub>i</sub>, v<sub>i</sub>]</code> indicates that there is an edge between nodes <code>u<sub>i</sub></code> and <code>v<sub>i</sub></code>.</p>
