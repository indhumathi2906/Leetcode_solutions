<h1>1216 - Print Zero Even Odd</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/print-zero-even-odd/">print-zero-even-odd</a></h2><p>You have a function <code>printNumber</code> that can be called with an integer parameter and prints it to the console.</p>
