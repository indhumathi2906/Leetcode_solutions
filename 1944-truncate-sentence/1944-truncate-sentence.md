<h1>1944 - Truncate Sentence</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/truncate-sentence/">truncate-sentence</a></h2><p>A <strong>sentence</strong> is a list of words that are separated by a single space with no leading or trailing spaces. Each of the words consists of <strong>only</strong> uppercase and lowercase English letters (no punctuation).</p>
