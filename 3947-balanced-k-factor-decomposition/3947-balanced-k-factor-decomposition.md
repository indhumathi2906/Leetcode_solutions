<h1>3947 - Balanced K-Factor Decomposition</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/balanced-k-factor-decomposition/">balanced-k-factor-decomposition</a></h2><p>You are given two integers <code>n</code> and <code>k</code>.</p>
