<h1>3415 - Check if Grid Satisfies Conditions</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/check-if-grid-satisfies-conditions/">check-if-grid-satisfies-conditions</a></h2><p>You are given a 2D matrix <code>grid</code> of size <code>m x n</code>. You need to check if each cell <code>grid[i][j]</code> is:</p>
