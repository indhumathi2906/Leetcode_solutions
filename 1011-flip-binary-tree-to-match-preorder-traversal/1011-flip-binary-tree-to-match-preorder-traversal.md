<h1>1011 - Flip Binary Tree To Match Preorder Traversal</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/flip-binary-tree-to-match-preorder-traversal/">flip-binary-tree-to-match-preorder-traversal</a></h2><p>You are given the <code>root</code> of a binary tree with <code>n</code> nodes, where each node is uniquely assigned a value from <code>1</code> to <code>n</code>. You are also given a sequence of <code>n</code> values <code>voyage</code>, which is the <strong>desired</strong> <a href="https://en.wikipedia.org/wiki/Tree_traversal#Pre-order" target="_blank"><strong>pre-order traversal</strong></a> of the binary tree.</p>
