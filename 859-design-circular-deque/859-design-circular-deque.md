<h1>859 - Design Circular Deque</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/design-circular-deque/">design-circular-deque</a></h2><p>Design your implementation of the circular double-ended queue (deque).</p>
