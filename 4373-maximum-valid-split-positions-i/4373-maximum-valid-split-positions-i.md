<h1>4373 - Maximum Valid Split Positions I</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/maximum-valid-split-positions-i/">maximum-valid-split-positions-i</a></h2><p>You are given an integer array <code>nums</code>.</p>
