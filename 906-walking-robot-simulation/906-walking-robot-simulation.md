<h1>906 - Walking Robot Simulation</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/walking-robot-simulation/">walking-robot-simulation</a></h2><p>A robot on an infinite XY-plane starts at point <code>(0, 0)</code> facing north. The robot receives an array of integers <code>commands</code>, which represents a sequence of moves that it needs to execute. There are only three possible types of instructions the robot can receive:</p>
