<h1>4286 - Valid Digit Number</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/valid-digit-number/">valid-digit-number</a></h2><p>You are given an integer <code>n</code> and a digit <code>x</code>.</p>
